...
directory = f"analysis_bandit"
simulations = [
    SimulationResult("Runs without configuration", f"{directory}/bandit-basic_*.csv"),
    SimulationResult("Runs with configuration", f"{directory}/bandit_*.csv"),
]
